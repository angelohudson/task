...
import 'package:task/app/modules/home/components/list_task/event_details/screen/event_comments.dart';
import 'package:task/app/modules/home/components/list_task/event_details/screen/table_schedule.dart';
...
class _EventDetailsViewState extends State<EventDetailsView> {
  ...
  void initState() {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      if (message.data['topico'] == 'novoComentario' &&
          message.data['eventId'] == this.widget._id.toString()) {
        setState(() {
