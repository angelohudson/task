import 'package:task/app/modules/home/components/list_task/event_details/event_details_view.dart';
import 'package:task/app/modules/home/components/list_task/input_justificativa.dart';
...
class ItemTaskComponent extends StatefulWidget {
  final Task _task;
  final bool active;
  final Future<bool> Function(int id, String just) _onRemove;

  ItemTaskComponent(this._task, this._onRemove, {this.active = true});

  @override
  State<StatefulWidget> createState() => _ItemTaskComponentState();
}

class _ItemTaskComponentState extends State<ItemTaskComponent> {
  ...
  Widget build(BuildContext context) {
    return Dismissible(
                    ...
                    Transform.scale(
                      ...
                      child: Checkbox(
                        value: this.widget._task.taskStatus ==
                            TaskStatus.CONFIRMADO,
                        onChanged: this.widget.active ? (val) {
                          this._onConfirm();
                        } : null,
                      ),
                    ),
      ...
      confirmDismiss: this.widget.active ? (direction) async {
